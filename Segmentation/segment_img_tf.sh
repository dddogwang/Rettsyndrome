...
filename="60x_4x_Dapi_test_50nmSTP007"
IMGNAME=${filename}_XY042.ome.tif
DATADIR=$HOME/DDDog/Datasets/221206SoRa/Ctrl/$filename/$IMGNAME

SAVEDIR=$HOME/DDDog/Epigenetic/Segmentation
WEIGHTDIR=$HOME/DDDog/Datasets/weights
RESULTDIR=$PYDIR

python $PYDIR/maskrcnn_test.py $DATADIR $IMGNAME $SAVEDIR $WEIGHTDIR $RESULTDIR
